...
// import 'package:floris/all_file.dart';
// import 'package:floris/app/data/provider/resful_service/net/dio_module.dart';
// import 'package:floris/app/data/services/service/local_data_service.dart';
...
// import 'package:floris/app/core/import/graphql_import.dart';
...
//   @override
//   void onReady() async {
//     _box = await Hive.openBox(AppConstant.KEY_BOX);
//
//     // listenTokenChange();
...
//       loggerCustom.i('AuthController.signInWithFacebook => $result');
//       if (result is AccessToken) {
//         loggerCustom.i('AuthController.signInWithFacebook => AccessToken');
//
//         // Login success
...
//               return value;
//             }, onError: (err) {
//           loggerCustom.e('AuthController.signInWithFacebook err => $err');
//           return Future.error(err);
//         });
//       } else if (result is LoginResult) {
//         loggerCustom.i('AuthController.signInWithFacebook => LoginResult');
...
//                   (value) => loggerCustom.i('logout facebook'),
//               onError: (err) => loggerCustom.e('login fb fail $err'));
//
//           loggerCustom.e('AuthController.signInWithFacebook err => $err');
...
//     } else {}
//
//     loggerCustom.e('signInWithFacebook error');
...
//   void onClose() {
//     // print('AuthController.tokenChangeStream => cancel');
//     loggerCustom.i('AuthController.tokenChangeStream => cancel');
//     tokenChangeStream?.cancel();
//     super.onClose();
//   }
//
